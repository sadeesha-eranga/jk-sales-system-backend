INSERT INTO branch (id, name, type, email, created_at, updated_at) VALUES(1, 'Head Office', 'HEAD_OFFICE', 'msadeeshaeranga@gmail.com', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
